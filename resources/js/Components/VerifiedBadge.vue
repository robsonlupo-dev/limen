...
<template>
    <span class="inline-flex items-center gap-1 text-xs font-medium text-gold" :title="verified.title">
        <svg width="13" height="13" viewBox="0 0 20 20" fill="currentColor" class="shrink-0">
            <path
                fill-rule="evenodd"
                d="M10 1.5l2.2 1.27 2.55-.2 1.1 2.3 2.3 1.1-.2 2.55L19.5 10l-1.27 2.2.2 2.55-2.3 1.1-1.1 2.3-2.55-.2L10 19.5l-2.2-1.27-2.55.2-1.1-2.3-2.3-1.1.2-2.55L.5 10l1.27-2.2-.2-2.55 2.3-1.1 1.1-2.3 2.55.2L10 1.5z"
            />
            <path
                fill-rule="evenodd"
                fill="#0A0A0B"
